...
export function AISparkleIcon({ size = 18, mono = false }: {
  size?: number;
  /* Paints the mark in `currentColor` instead of the Wordgenie gradient. For a
     sparkle sitting ON a solid Interface Blue button, the blue→violet gradient
     renders dark-on-blue and all but disappears; inheriting the button's own
     text colour keeps the glyph and its label one object. Opt-in, so every
     existing use keeps the gradient.
     This doesn't bend The Gradient Means AI Rule: the button is already the AI
     action and already carries the meaning — the gradient was just illegible at
     this size on this background. */
  mono?: boolean;
}) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <path d="M16 4L13.4507 11.7507C13.3202 12.1473 13.0984 12.5078 12.8031 12.8031C12.5078 13.0984 12.1473 13.3202 11.7507 13.4507L4 16L11.7507 18.5493C12.1473 18.6798 12.5078 18.9016 12.8031 19.1969C13.0984 19.4922 13.3202 19.8527 13.4507 20.2493L16 28L18.5493 20.2493C18.6798 19.8527 18.9016 19.4922 19.1969 19.1969C19.4922 18.9016 19.8527 18.6798 20.2493 18.5493L28 16L20.2493 13.4507C19.8527 13.3202 19.4922 13.0984 19.1969 12.8031C18.9016 12.5078 18.6798 12.1473 18.5493 11.7507L16 4Z" fill={mono ? "currentColor" : "url(#wgIconGradA)"} stroke={mono ? "currentColor" : "url(#wgIconGradA)"} strokeWidth="1.125" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M6 2L5.15022 4.58356C5.10673 4.71578 5.0328 4.83595 4.93437 4.93437C4.83595 5.0328 4.71578 5.10673 4.58356 5.15022L2 6L4.58356 6.84978C4.71578 6.89327 4.83595 6.9672 4.93437 7.06563C5.0328 7.16405 5.10673 7.28422 5.15022 7.41644L6 10L6.84978 7.41644C6.89327 7.28422 6.9672 7.16405 7.06563 7.06563C7.16405 6.9672 7.28422 6.89327 7.41644 6.84978L10 6L7.41644 5.15022C7.28422 5.10673 7.16405 5.0328 7.06563 4.93437C6.9672 4.83595 6.89327 4.71578 6.84978 4.58356L6 2Z" fill={mono ? "currentColor" : "url(#wgIconGradB)"} stroke={mono ? "currentColor" : "url(#wgIconGradB)"} strokeWidth="0.375" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M26 22L25.1502 24.5836C25.1067 24.7158 25.0328 24.8359 24.9344 24.9344C24.8359 25.0328 24.7158 25.1067 24.5836 25.1502L22 26L24.5836 26.8498C24.7158 26.8933 24.8359 26.9672 24.9344 27.0656C25.0328 27.1641 25.1067 27.2842 25.1502 27.4164L26 30L26.8498 27.4164C26.8933 27.2842 26.9672 27.1641 27.0656 27.0656C27.1641 26.9672 27.2842 26.8933 27.4164 26.8498L30 26L27.4164 25.1502C27.2842 25.1067 27.1641 25.0328 27.0656 24.9344C26.9672 24.8359 26.8933 24.7158 26.8498 24.5836L26 22Z" fill={mono ? "currentColor" : "url(#wgIconGradC)"} stroke={mono ? "currentColor" : "url(#wgIconGradC)"} strokeWidth="0.375" strokeLinecap="round" strokeLinejoin="round"/>
      <defs>
