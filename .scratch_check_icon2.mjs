...
// also capture Present and Share dropdowns for style comparison
await page.locator('button:has-text("Present")').first().click({ timeout: 10000 });
await page.waitForTimeout(400);
await page.screenshot({ path: '.scratch-present-menu.png' });
await page.keyboard.press('Escape').catch(()=>{});

await page.locator('button:has-text("Share")').first().click({ timeout: 10000 });
await page.waitForTimeout(400);
await page.screenshot({ path: '.scratch-share-menu.png' });
